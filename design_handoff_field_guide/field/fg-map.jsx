/* GemSpot Field Guide — stylized cartographic map of central Tallinn.
   Survey-paper base · hatched water · contoured hill · coordinate grid.
   viewBox 0 0 1000 680, sliced to fill. Ink drawn with currentColor. */

function FgMapCanvas() {
  return (
    <svg viewBox="0 0 1000 680" preserveAspectRatio="xMidYMid slice"
      ...
      {/* Old Town — dashed bastion outline */}
...
Object.assign(window, { FgMapCanvas });
